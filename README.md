...
Health institutions have a responsibility to proactively research and disclose security vulnerabilities, and reduce risks for AI to be weaponized by bad actors in bad faith. Institutions are encouraged to assess their Generative AI systems against the OWASP Top 10 <a href="https://llmtop10.com>, OWASP AI Security & Governance Checklist <a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/llm-top-10-governance-doc/LLM_AI_Security_and_Governance_Checklist-v1.pdf" and the latest guidelines from NIST & CISA around secure, responsbile and private AI.
    </td>
  </tr>
</table>
